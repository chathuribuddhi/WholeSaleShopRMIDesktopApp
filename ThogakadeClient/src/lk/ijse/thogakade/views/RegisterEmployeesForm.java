 ...
 * @author CHATHURI
 */
public class RegisterEmployeesForm extends javax.swing.JFrame {
    
    EmployeeController ctrlEmployee;

    /**
     * Creates new form RegisterEmployeesForm
     */
    public RegisterEmployeesForm() {
        initComponents();
        try {
            ...
            Logger.getLogger(RegisterEmployeesForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void setOrderId(){
        try {
            int a = (ctrlEmployee.getAll().size()) + 1;
            System.out.println("E00"+a);
            if(a<10){
                txtID.setText("E00"+a);
            }else if(a<100){
                txtID.setText("E0"+a);
...
//        }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txtTele, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            boolean result = ctrlEmployee.add(employee);
            if (result){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterEmployeesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterEmployeesForm().setVisible(true);
            }
        });
    }
